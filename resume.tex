  ...
  \resumeSubHeadingListStart
	...
	\item {
      ...
      \textbf{Active LIR}{: ASN, IPv4, IPv6, IPAM, RDNS, RPKI}
   	...
   	\item {
      \textbf{CDN/Traffic Management}{: CloudFlare, Akamai, F5 GTM, multicast DNS}
	}
   	\item {
      ...
      \textbf{Security}{: Physical and Digital Security Advisory/Audit}
   	...
   	\item {
      \textbf{Compliance}{: GDPR, PCI DSS, PSD2}
	}
   	\item {
...
\
        ...
        \resumeItem{Tech Consulting}
          {As a tech consultancy we specialize in DevOps, Dev and Data Analytics, tough projects like infrastructure architecture in hybrid-,on-premise- and multi-cloud setup, migrations and many many more }
    ...
    \resumeSubheading
      ...
      {DevOps Consultant}{Oct 2019 - Sep 2020}
      \resumeItemListStart
      \ 
...
The project goal was to reduce customer-facing incident impact during major platform outages. In case of major incident in live processing datacenter, the automated solution is supposed to detect failure condition and switchover complete transaction processing to DR site.
    ...
    \resumeSubheading
      {ACI Worldwide Germany GmbH | Banking \& Payments Solutions}{Munich, Germany}
      {Senior Software Engineer (DevOps)}{Nov 2015 - Oct 2019}
      \resumeItemListStart
...
\
    ...
    \resumeSubheading
      {PAY.ON AG (now part of ACI) | Whitelabel Payment Services Provider}{Munich, Germany}
      {Senior Software Engineer (DevOps)}{Sep 2014 - Nov 2015}

      
    \resumeSubheading
      {Gastrofix GmbH (now part of Lightspeed) | Innovative POS\&Cash Register}{Berlin, Germany}
      {Java Web Developer}{Jan 2012 - Dec 2013}
      \resumeItemListStart
        \resumeItem{Fullstack Developer}
          {I was covering web frontend, backend. Our system evolves around iOS application, that is managed by Web UI. Backoffice stack consists of Angular, Spring, JasperReports and PostgreSQL+Mongo.}
        \resumeItem{DevOps Engineer}
          {Was responsible for database and servers’ healthcare, webops, devops and backups. Using Chef, Jenkins, Munin and Nagios and a lot of other stuff for dev/web operations. Maintained iOS CI/CD pipeline }
        \resumeItem{iOS WebUI Developer}
          {Also worked on some mobile parts, for example implemented convenient multi-layered SVG-based restaurant room designer}
      \resumeItemListEnd

    \resumeSubheading
      {8 more projects}{Kyiv, Ukraine}
      {as Developer, DevOps, System Administrator, Team Lead}{Sep 2003 - Apr 2013}
...
\section{Publications}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {8 other technical articles (in Russian)}{2011-2012 for https://habr.com/}
      {Mostly Software Development topics}{}
      \
      
      \href{https://habr.com/en/users/1ex/posts/}{https://habr.com/en/users/1ex/posts/}
